...
class ClientProfile(models.Model):
    ...
    exename = models.CharField(max_length=100, default='AcilBir', verbose_name="EXE Name")
    appname = models.CharField(max_length=100, default='AcilBir', verbose_name="App Name")
    compname = models.CharField(max_length=100, default='ABT Bilgisayar Programlama ve Tic.Ltd.Sti.', verbose_name="Company Name")
    androidappid = models.CharField(max_length=100, default='com.acilbir.app', verbose_name="Android App ID")
    ...
    urlLink = models.CharField(max_length=200, blank=True, default='https://acilbir.com')
